...
public class DetailsActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {;
        ...
        page = String.valueOf(getIntent().getIntExtra("page", 1));
        ...
        value = getIntent().getBooleanExtra("vip_list", false);
        SharedPreferences mSharedPreference1 =  getSharedPreferences("lists", Context.MODE_PRIVATE);
        if (value) {
             mSharedPreference1 = getSharedPreferences("lists_vip", Context.MODE_PRIVATE);
        }
        ...
        {
            try {
                liste.put(new JSONObject(mSharedPreference1.getString("ads_list_" + i,"")));
        ...
        Krw_functions.pushOpenScreenEvent(getApplicationContext(), Krw_functions.Current_country(getApplicationContext())
                + "/details/user=" + myads.getUser_id() + "/city=" + myads.getCity_name() + "/category&sub_category=" + myads.getCategory_name() + "/ads_id=" + adsID);
    ...
    public void load_ads(final Annonce myadsTag) {
        ...
        mDemoSlider[0].setFocusable(true);
                ...
                if (img_url.size() > 0) {
                    ...
                    ArrayList<Integer> keys = new ArrayList<>(url_maps.keySet());
                        ...
                        for (Integer name : url_maps.keySet()) {
                            TextSliderView2 textSliderView = new TextSliderView2(DetailsActivity.this);
                        ...
                        mDemoSlider[0].addOnPageChangeListener(DetailsActivity.this);
...
//                        chooserIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS, targetedShareIntents.toArray(new Parcelable[]{}));
                    ...
                    Intent share = new Intent(android.content.Intent.ACTION_SEND); //creation de l'intent de partage
                    share.setType("text/plain"); //type de partage
                    //texte à partager
                    String message = "L'annonce  \" "+myads.getTitle()+" \" de preprod.kerawa.com peut t'intéresser, cliques sur le lien ci dessous pour en savoir plus.\n" +
                            myads.getFriendly_url()+"\n\n"+
                            "**************\n"+
                            "Pensez aussi à télécharger l'application Android preprod.kerawa.com sur Playstore (https://play.google.com/store/apps/details?id=com.kerawa.app) ou sur preprod.kerawa.com/Android directement ";
                    //fin texte
                    //ajout du contenu dans le intent
                    share.putExtra(android.content.Intent.EXTRA_SUBJECT, myads.getTitle());
                    share.putExtra(android.content.Intent.EXTRA_TEXT, message);
                    startActivity(Intent.createChooser(share, "Partagez via"));
                }
                catch(Exception e){
                    e.printStackTrace();
                }
            ...
            public void onClick(View v) {
                ...
                if (!myads.getEmail().trim().equals("")) {
                    ...
                    if (intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        text.setText("Veuillez installer une application de messagerie pour effectuer cette operation");
            ...
            public void onClick(View v) {
                ...
                if (!myads.getPhone2().trim().equalsIgnoreCase("null") && !myads.getPhone2().trim().equalsIgnoreCase("")) {
                    if (!myads.getPhone1().trim().equalsIgnoreCase("null") && !myads.getPhone1().trim().equalsIgnoreCase("")) {
                        ...
                        bundle.putString("adsId", adsID);
                        bundle.putString("usercity", myads.getCity_name());
                        Intent callsms = new Intent(DetailsActivity.this, makeCallorText.class);
                    ...
                    if (!myads.getPhone1().trim().equalsIgnoreCase("null") && !myads.getPhone1().trim().equalsIgnoreCase("")) {
                        ...
                        bundle.putString("adsId", adsID);
                        bundle.putString("usercity", myads.getCity_name());
                        Intent intent1 = new Intent(DetailsActivity.this, makeCallorText.class);
    ...
    private void LoadPrevious() {
        if(position!=0) {
            ...
            Toast.makeText(getApplicationContext(),"Pas d'annonce precedente",Toast.LENGTH_LONG).show();
    }
    ...
    private void LoadNext() {
      ...
      if(liste != null) {
          if (position == liste.length() - 1) {
              ...
              position = position + 1 ;*/
              Toast.makeText(getApplicationContext(), "Pas d'annonce suivante", Toast.LENGTH_LONG).show();
          } else {
    ...
    private void LoadSimilars(String ad_title) {
        ...
        JsonObjectRequest movieReq = new JsonObjectRequest(Request.Method.GET, Kerawa_Parameters.PreProdURL+
                "list_ads?country="+nom+"&category="+getIntent().getStringExtra("category")+"&search="+encoded_title, new Response.Listener<JSONObject>() {
            @Override
    ...
    private void LoadMore() {
     ...
     //ville
        ...
        if (nom == null) {
            ...
            String first_url = Kerawa_Parameters.PreProdURL + next_url.substring(1);
    ...
    public Action getAction() {
        Thing object = new Thing.Builder()
                ...
                .setUrl(Uri.parse("https://www.preprod.kerawa.com/" + myads.getFriendly_url()))
                .build();

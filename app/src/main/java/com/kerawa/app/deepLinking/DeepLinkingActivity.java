    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent home = new Intent(DeepLinkingActivity.this, AdsListActivity.class);
                startActivity(home);
                finish();
            }
        });
        ...
        createAdsButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Krw_functions.Open_Connection_or_register(DeepLinkingActivity.this, R.id.action_add);
            }
        });
        ...
        searchclose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                InputMethodManager imm = (InputMethodManager)DeepLinkingActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        profileButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Krw_functions.Open_Connection_or_register(DeepLinkingActivity.this, R.id.action_account);
            }
        });
       ...
       /* Toast.makeText(this, " YOUR COUNTRY   "+nom, Toast.LENGTH_LONG).show();*/


        String pays_id1 = (String) getIntent().getStringExtra("PAYSID1");



        String pays_id2 = (String) getIntent().getStringExtra("PAYSID2");
        String city_id2 = (String) getIntent().getStringExtra("CITYID2");


        String pays_id3 = (String) getIntent().getStringExtra("PAYSID3");
        String cat_id3 = (String) getIntent().getStringExtra("CATID3");
        String cit3 = (String) getIntent().getStringExtra("CIT3");


        String country_id = (String) getIntent().getStringExtra("COUNTRYID");
        String subcat_id = (String) getIntent().getStringExtra("SUBCATID");
        String cit = (String) getIntent().getStringExtra("CIT");
...
//==================================================================================================================
        ...
        if( pays_id1 != null ){
            ...
            Toast.makeText(this, " PAYS    "+pays_id1, Toast.LENGTH_LONG).show();
            // list_ads?country=40

            //construction the first url to search ads on server
//             first_url = url + "regions/" + nom + added_url + "/ads?" + category;
            first_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+pays_id1;
            ...
            swipeRefreshLayout.setColorSchemeResources(R.color.blue_kerawa, R.color.amber_500, R.color.kerawa_red);
            ...
            loader = (pl.droidsonroids.gif.GifImageView) findViewById(R.id.loader);
            ...
            }else
            {
                ...
                Toast.makeText(DeepLinkingActivity.this, "Verifiez votre connexion et essayez encore", Toast.LENGTH_SHORT).show();
...
//==================================================================================================================
        ...
        //annonces d'une ville d'un pays
        if( pays_id2 !=null  &&   city_id2!=null ){
            Toast.makeText(this, " paysID   "+pays_id2, Toast.LENGTH_LONG).show();
            Toast.makeText(this, " CITYID   "+city_id2, Toast.LENGTH_LONG).show();
            // list_ads?category=12&city=334&country=40

            first_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+pays_id2+"&city="+city_id2;
            second_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+pays_id2+"&city="+city_id2+"&onlyvip=true";
...
//==================================================================================================================
        ...
        //annonces d'une categorie
        if( pays_id3!=null  && cat_id3!=null && cit3 !=null ){
            Toast.makeText(this, " PAYS_ID   "+pays_id3, Toast.LENGTH_LONG).show();
            Toast.makeText(this, " CATEGORIE_ID   "+cat_id3, Toast.LENGTH_LONG).show();
            Toast.makeText(this, " CITY_ID   "+cit3, Toast.LENGTH_LONG).show();
            // list_ads?category=12&city=334&country=40

            first_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+pays_id3+"&city="+cit3+"&category="+cat_id3;
...
//==================================================================================================================
//==================================================================================================================
        //annonces d'une sous categorie
        if( country_id!=null  &&  subcat_id!=null && cit !=null ){

            // list_ads?category=12&city=334&country=40

            Toast.makeText(this, " PAYS_ID   "+country_id, Toast.LENGTH_LONG).show();
            Toast.makeText(this, " SUBCATEGORIE_ID   "+subcat_id, Toast.LENGTH_LONG).show();
            Toast.makeText(this, " CITY_ID   "+cit, Toast.LENGTH_LONG).show();
            // list_ads?category=12&city=334&country=40

            first_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+country_id+"&city="+cit+"&category="+subcat_id+"&onlyvip=true";
            second_url = Kerawa_Parameters.PreProdURL +"list_ads?country="+country_id+"&city="+cit+"&category="+subcat_id;
...
//        bundle.putString("search", "search");
        if (!keyword.trim().equals("") && Krw_functions.isConnected(DeepLinkingActivity.this)){
            if ((DeepLinkingActivity.this).getSupportActionBar() != null){
                getSupportActionBar().setTitle(String.format("Recherche: %s", keyword0));
            }
...
//                        + nom + "/ads/vip?"+getIntent().getStringExtra("custom"),
                ...
                JsonObjectRequest vipRequest = new JsonObjectRequest(Request.Method.GET, Kerawa_Parameters.PreProdURL +
                        "list_ads?category="+getIntent().getStringExtra("custom")+"&sort=-date&search="+keyword0,
            ...
            Show_Toast(DeepLinkingActivity.this, "Bien vouloir remplir du texte", false);
        }
        Krw_functions.pushOpenScreenEvent(DeepLinkingActivity.this, Krw_functions.Current_country(DeepLinkingActivity.this) + "/search/" + keyword.replace(" ", "_"));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i <= arr.length() - 1; i++) {
                        ...
                        if(arr.getJSONObject(i).has("ad_title")) {
                            an.setTitle(arr.getJSONObject(i).get("ad_title").toString());
                            Log.i("ad_title","===================ad_title====="+arr.getJSONObject(i).get("ad_title").toString()+"============================");

                        }
                        if (arr.getJSONObject(i).has("ad_image_thumbnail_url")) {
                            an.setImage_thumbnail_url(arr.getJSONObject(i).get("ad_image_thumbnail_url").toString().replace("https", "http"));
                            Log.i("ad_image_thumbnail_url", "===================ad_image_thumbnail_url=====" + arr.getJSONObject(i).get("ad_image_thumbnail_url").toString() + "============================");
                        } else {
                            an.setImage_thumbnail_url("");
                        }
                        ...
                        if (arr.getJSONObject(i).has("ad_images_urls")) {
                            ...
                            for(int k=0;k<liste_img.length();k++){
                                images.add(liste_img.get(k).toString().replace("https", "http"));
                                Log.i("ad_images_urls", "===================ad_images_urls=====" + arr.getJSONObject(i).get("ad_images_urls").toString() + "============================");
                            }
                            an.setImgList(images);
                        }
                        ...
                        if (arr.getJSONObject(i).has("ad_price")) {
                            ...
                            //price = String.format("%,d", (arr.getJSONObject(i).getString("price") == null ||arr.getJSONObject(i).getString("price").equals("null") ) ? 0 : Integer.parseInt(arr.getJSONObject(i).getString("price")));
                            price =price_formated(arr.getJSONObject(i).getString("ad_price"));
                            Log.i("ad_price","===================ad_price====="+arr.getJSONObject(i).get("ad_price").toString()+"========");

                        }
                        if (arr.getJSONObject(i).has("ad_short_link")) {
                            an.setFriendly_url(arr.getJSONObject(i).get("ad_short_link").toString());
                            Log.i("ad_short_link", "===================ad_short_link=====" + arr.getJSONObject(i).get("ad_short_link").toString() + "============================");
                        }
                        if (arr.getJSONObject(i).has("ad_user_id")) {
                            an.setUser_id(arr.getJSONObject(i).getString("ad_user_id"));
                            Log.i("ad_user_id", "===================ad_user_id=====" + arr.getJSONObject(i).get("ad_user_id").toString() + "========");
                        }
                        String currency = "";
                        if (arr.getJSONObject(i).has("ad_currency")) {

                            currency = arr.getJSONObject(i).get("ad_currency").toString();
                            Log.i("ad_currency","===================ad_currency====="+arr.getJSONObject(i).get("ad_currency").toString()+"========");
                            an.setCurrency(currency);
                            if (currency.equals("null")) currency = "";
                        }
                        if (price.equals("0")||price.equals("")) {
                        ...
                        if (arr.getJSONObject(i).has("ad_city_name")) {
                            an.setCity_name(arr.getJSONObject(i).get("ad_city_name").toString());
                            Log.i("ad_city_name", "===================ad_city_name=====" + arr.getJSONObject(i).get("ad_city_name").toString() + "========");
                        }

                        if (arr.getJSONObject(i).has("ad_phonenumber")) {
                            an.setPhone1(arr.getJSONObject(i).get("ad_phonenumber").toString());
                            Log.i("ad_phonenumber", "===================ad_phonenumber=====" + arr.getJSONObject(i).get("ad_phonenumber").toString() + "========");
                        }
                        ...
                        if (arr.getJSONObject(i).has("ad_description")) {
                            an.setDescription(arr.getJSONObject(i).get("ad_description").toString());
                            Log.i("ad_description", "===================ad_description=====" + arr.getJSONObject(i).get("ad_description").toString() + "========");
                        }
                        if (arr.getJSONObject(i).has("ad_contactemail")) {
                            an.setEmail(arr.getJSONObject(i).get("ad_contactemail").toString());
                            Log.i("ad_contactemail", "===================ad_contactemail=====" + arr.getJSONObject(i).get("ad_contactemail").toString() + "========");
                        }

                        if (arr.getJSONObject(i).has("ad_category_name")) {
                            an.setCategory_name(arr.getJSONObject(i).getString("ad_category_name") + " -> " + arr.getJSONObject(i).getString("ad_subcategory_name"));
                            Log.i("ad_category_name", "===================ad_category_name=====" + arr.getJSONObject(i).get("ad_category_name").toString() + "========");
                        }
                        if (arr.getJSONObject(i).has("ad_email")) {
                            an.setEmail(arr.getJSONObject(i).getString("ad_email"));
                            Log.i("ad_email", "===================ad_email=====" + arr.getJSONObject(i).get("ad_email").toString() + "========");
                        }
                        if (arr.getJSONObject(i).has("ad_url")) {
                            an.setAd_url(arr.getJSONObject(i).get("ad_url").toString());
                            Log.i("ad_url", "===================ad_url=====" + arr.getJSONObject(i).get("ad_url").toString() + "========");
                        }
                        //an.setDate(arr.getJSONObject(i).get("ad_date").toString());
                    ...
                    if (obj.has("next")) {
                        ...
                        Log.i("next", "===================next=====" + obj.getString("next") + "========");
                        /*if (!recherche.equals("")) {
                        ...
                        listView.setOnScrollListener(new EndlessScrollListener() {
                            ...
                            public void onLoadMore(int page, int totalItemsCount) {
                                ...
                                curent_page = page ;
                                if (isConnected(DeepLinkingActivity.this)) {
                                    customLoadMoreDataFromApi(next_url);
                                   // Krw_functions.pushOpenScreenEvent(DeepLinkingActivity.this, Krw_functions.Current_country(getApplicationContext()) + "/caterory=" + cat_name + "/page=" + page);
                   ...
                   /* Errors_handler msg_err=new Errors_handler(DeepLinkingActivity.this, getApplicationContext(),"Un probleme est survenu lors du chargement des annonces.",true, (TextView) statusText,R.drawable.errore);
                    msg_err.execute(1500, 500, 6000);*/
                    new ShowHide(loader).Hide();
                    new ShowHide(gridLoader).Hide();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if(response != null && response.data != null)
                            switch (response.statusCode) {
                                case 500:
                                    try {
                                        Errors_handler msg_err = new Errors_handler(DeepLinkingActivity.this, getApplicationContext(), "Aucune annonce dans cette categorie\r\nVeuillez changer", true, (TextView) statusText, R.drawable.errore);
                                        msg_err.execute(1500, 500, 6000);
                                        new ShowHide(loader).Hide();
                                        new ShowHide(gridLoader).Hide();
                                    } catch (Exception ignored) {
    ...
    private void customLoadMoreDataFromApi(String next_ul) {
        ...
        loader= DeepLinkingActivity.this.findViewById(R.id.loader);
        gridLoader = (pl.droidsonroids.gif.GifImageView)gridViewL2.findViewById(R.id.loader);
        loader.setVisibility(View.VISIBLE);
        gridLoader.setVisibility(View.VISIBLE);
       // if(!category.equals(""))
            next_ul=val.substring(0,index+1)+val.substring(index+1,val.length()) ;
        JsonObjectRequest movieReq1 = new JsonObjectRequest(Request.Method.GET, url+next_ul.substring(1), new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    try {
                        Errors_handler msg_err=new Errors_handler(DeepLinkingActivity.this, getApplicationContext(),
                                "Un probleme est survenu lors du chargement des annonces.",true,
                                (TextView) DeepLinkingActivity.this.findViewById(R.id.statusText),R.drawable.errore);
                        msg_err.execute(500, 500, 6000);
                    }catch (Exception ex){
                        Log.d("Error_Handler", ex.getMessage());
                    }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                Map<String, String> params = new HashMap<>();
                params.put("X-Kerawa-Api-Consumer-Key",new Kerawa_Parameters(DeepLinkingActivity.this).Hide_meta_data());
                return params;
            }
        };

        MySingleton.getInstance(DeepLinkingActivity.this).addToRequestQueue(movieReq1);
...
//        movieList.get(0).getAdd_id()
        JsonObjectRequest movieReq = new JsonObjectRequest(Request.Method.GET, Kerawa_Parameters.PreProdURL+
                "list_recents_ads_from/"+movieList.get(0).getAdId(),
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        // the response is already constructed as a JSONObject!
